...
const spots: Spot[] = [
  ...
  },
  {
    ...
    category: 'ガールズバー',
    description:
      '大阪にあるガールズバー「まりんちゅ〜る」。タイではないが、旅の前後に立ち寄りたい一軒。明るくアットホームな雰囲気で、スタッフとの会話が楽しい。海をテーマにした内装が特徴的。おんぷちゃんをはじめ、個性豊かなスタッフが揃っている。',
    photos: [
      {
    ...
    mapUrl: 'https://maps.google.com/?q=まりんちゅ〜る+大阪',
    address: '大阪府大阪市',
    ...
    reviews: [
      {
        source: '口コミ',
        rating: 5,
        comment: 'おんぷちゃんが可愛すぎる！！笑顔が最高で話も面白くて、気づいたら何時間も居てしまった。また絶対来る！',
      },
      {
        source: 'Googleマップ',
        rating: 5,
        comment: 'おんぷちゃん目当てで来店。想像以上に可愛くてテンション上がりました。接客も丁寧でホントに癒される。',
      },
      {
        source: 'Twitter（X）',
        rating: 5,
        comment: 'まりんちゅ〜るのおんぷちゃん、マジで可愛い。声も雰囲気もタイプすぎてリピ確定。通い詰めるやつだこれ。',
      },
      {
        source: '食べログ',
        rating: 5,
        comment: 'おんぷちゃんがとにかく可愛い。笑顔がキラキラしてて元気もらえる。タイ旅行帰りに寄ったら疲れが吹き飛んだ！',
      },
      {
        source: 'Instagram',
        rating: 5,
        comment: 'おんぷちゃんの天真爛漫な感じが好きすぎる。ドリンク作ってくれる時の動きもいちいちかわいい。推しが増えました。',
      },
      {
        source: '口コミ（常連より）',
        rating: 5,
        comment: 'もう何度来たかわからないくらいリピしてる。おんぷちゃんはいつ来ても可愛いし、覚えてくれてるのが嬉しい。大阪一かわいいガールズバー認定。',
      },
      {
        source: 'Googleマップ',
        rating: 5,
        comment: 'りんちゃんがめちゃくちゃ飲む！お客さんと一緒にガンガン飲んでくれるから場が盛り上がりまくる。一緒に飲んでて本当に楽しいスタッフさん。また飲みに行きたい！',
      },
      {
        source: '口コミ',
        rating: 5,
        comment: 'りんちゃんのお酒の強さが伝説級。こっちが先に潰れそうになるくらい飲んでくれる。飲み仲間として最高すぎる。おんぷちゃんと2人体制でいつ行っても最高の夜になる。',
      },
    ],
  },
  {
